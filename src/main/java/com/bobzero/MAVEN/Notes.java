 ...
 * 
 * NOTE
 * Maven follows the standard order like as you choose the command of the life cycle
 * the other commands before the command you run are going to be executed as well...
 * 
 */